...
{
    public partial class WFV_Progress : Form
    {
        ...
        public WFV_Progress(string lbText, int maxprogress, Action<object, EventArgs> actionRegistrant, Action<object, EventArgs> postActionRegistrant = null)
        {
            InitializeComponent();
